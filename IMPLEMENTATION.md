...
> **Tagline:** *"Protecting India from Medical Bankruptcy — One Family at a Time"*
...
graph TB
    ...
    subgraph "THE GAP — Nobody Is Here"
        AR["🛡️ AarogyaRaksha<br/>Citizen-Facing Intelligence Layer<br/>AI-Powered Financial Shield"]
    end
...
graph TB
    subgraph "Frontend — Next.js 14 App Router"
        UI["🖥️ Responsive UI<br/>Hindi + English"]
...
{
  "cataract_surgery": {
    "public": "₹0–5,000", "private": "₹25,000–80,000",
    "pmjay": "Fully covered", "recovery": "1-2 weeks"
  },
  "diabetes_annual": {
    "branded_monthly": "₹3,000–8,000", "generic_monthly": "₹400–1,200",
    "annual_checkups": "₹5,000–15,000"
  },
  "heart_bypass": {
    "public": "₹1.5–3L", "private": "₹3–8L",
    "pmjay": "Covered up to ₹5L"
  },
  "cancer_chemo_cycle": {
    "per_cycle": "₹8,000–2,00,000", "full_course": "₹2.5–25L"
  }
}
```
...
### Module 5: 🛡️ Emergency Health Fund Calculator
...
:root {
  ...
  /* Warning/Danger */
  --warning-500: #f59e0b;  --danger-500: #ef4444;
  /* Dark Mode Base */
  --bg-primary: #0a0f1e;   --bg-secondary: #111827;
...
- Gemini API returns valid structured JSON for all prompt templates
- Medicine search returns correct Jan Aushadhi alternatives
- Bill analyzer flags known overcharging patterns
- Responsive: 375px (mobile), 768px (tablet), 1440px (desktop)

### Manual
- Test scheme matcher with all 3 user personas
- Upload 3 sample hospital bills → verify anomaly detection
- Search 10 common medicines → verify price comparison accuracy
...
- [ ] Live Vercel URL
- [ ] PDF problem statement (3 pages, government data citations)
- [ ] PPT presentation (12-15 slides)
- [ ] Video walkthrough (5-7 minutes)
- [ ] Submitted on ConnectsBlue before April 30, 11:59 PM IST
